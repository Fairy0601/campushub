 ...
 * Package: com.campushub.community.quartz
 * Description:帖子分数刷新--Quartz
 *
 * @Author 欣欣欣
 * @Create 2025/3/11 11:21
 * @Version 1.0
 */
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        while (operations.size() > 0) {  //只要redis中有数据（帖子id），就持续刷新
